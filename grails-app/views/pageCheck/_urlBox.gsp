...
<div style="margin-top:10px;margin-bottom:10px;">
    <g:form action="index" method="get">
        <g:message code="ltc.wikicheck.url"/> <input autofocus style="width:350px" name="url" value="${url?.decodeURL()?.encodeAsHTML()}" placeholder="${message(code:'ltc.wikicheck.placeholder')}"/>
