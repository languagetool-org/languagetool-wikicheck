...
./cleancache.sh
grails --offline war && \
  scp target/languagetool-wikicheck-0.1.war languagetool@community2.languagetool.org:/tmp/wikicheck.war && \
  ssh languagetool@community2.languagetool.org unzip -d /home/languagetool/tomcat/webapps/wikiCheck /tmp/wikicheck.war && \
